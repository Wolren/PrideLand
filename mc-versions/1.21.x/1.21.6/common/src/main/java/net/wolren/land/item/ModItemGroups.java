    ...
    public static final ItemGroup PRIDE_LAND_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            ItemGroup.create(null, -1)
                    ...
                    .entries((displayParameters, entries) -> {
                        addItemsToGroup(entries);
                    })
                    .build()
    );

    public static void addItemsToGroup(ItemGroup.Entries entries) {
        ...
        if (ModItems.RAINBOW_SIGN != null) entries.add(ModItems.RAINBOW_SIGN);
        if (ModItems.RAINBOW_HANGING_SIGN != null) entries.add(ModItems.RAINBOW_HANGING_SIGN);
        ...
        if (ModItems.RAINBOW_BOAT != null) entries.add(ModItems.RAINBOW_BOAT);
        if (ModItems.RAINBOW_CHEST_BOAT != null) entries.add(ModItems.RAINBOW_CHEST_BOAT);
