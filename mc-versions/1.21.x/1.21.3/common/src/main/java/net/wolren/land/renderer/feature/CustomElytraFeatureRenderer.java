...
public class CustomElytraFeatureRenderer extends FeatureRenderer<BipedEntityRenderState, EntityModel<? super BipedEntityRenderState>> {
    ...
    public CustomElytraFeatureRenderer(FeatureRendererContext<BipedEntityRenderState, EntityModel<? super BipedEntityRenderState>> context, EntityModelLoader loader, Identifier defaultElytraTexture) {
        super(context);
