...
public class ModBlocks {
    ...
    // Stained Glass
    public static final StainedGlassBlock RAINBOW_STAINED_GLASS = (StainedGlassBlock) registerBlock("rainbow_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("rainbow_stained_glass")));
    ...
    public static final StainedGlassBlock TRANS_STAINED_GLASS = (StainedGlassBlock) registerBlock("trans_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("trans_stained_glass")));
    ...
    public static final StainedGlassBlock NONBINARY_STAINED_GLASS = (StainedGlassBlock) registerBlock("nonbinary_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("nonbinary_stained_glass")));
    ...
    public static final StainedGlassBlock BISEXUAL_STAINED_GLASS = (StainedGlassBlock) registerBlock("bisexual_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("bisexual_stained_glass")));
    ...
    public static final StainedGlassBlock PANSEXUAL_STAINED_GLASS = (StainedGlassBlock) registerBlock("pansexual_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("pansexual_stained_glass")));
    ...
    public static final StainedGlassBlock AROMANTIC_STAINED_GLASS = (StainedGlassBlock) registerBlock("aromantic_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("aromantic_stained_glass")));
    ...
    public static final StainedGlassBlock DEMISEXUAL_STAINED_GLASS = (StainedGlassBlock) registerBlock("demisexual_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("demisexual_stained_glass")));
    ...
    public static final StainedGlassBlock AGENDER_STAINED_GLASS = (StainedGlassBlock) registerBlock("agender_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("agender_stained_glass")));
    ...
    public static final StainedGlassBlock PROGRESS_PRIDE_STAINED_GLASS = (StainedGlassBlock) registerBlock("progress_pride_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("progress_pride_stained_glass")));
    ...
    public static final StainedGlassBlock ASEXUAL_STAINED_GLASS = (StainedGlassBlock) registerBlock("asexual_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("asexual_stained_glass")));
    ...
    public static final StainedGlassBlock GENDERFLUID_STAINED_GLASS = (StainedGlassBlock) registerBlock("genderfluid_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("genderfluid_stained_glass")));
    ...
    public static final StainedGlassBlock LESBIAN_STAINED_GLASS = (StainedGlassBlock) registerBlock("lesbian_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("lesbian_stained_glass")));
    ...
    public static final StainedGlassBlock DEMIBOY_STAINED_GLASS = (StainedGlassBlock) registerBlock("demiboy_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("demiboy_stained_glass")));
    ...
    public static final StainedGlassBlock DEMIGIRL_STAINED_GLASS = (StainedGlassBlock) registerBlock("demigirl_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("demigirl_stained_glass")));
    ...
    public static final StainedGlassBlock GENDERQUEER_STAINED_GLASS = (StainedGlassBlock) registerBlock("genderqueer_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("genderqueer_stained_glass")));
    ...
    public static final StainedGlassBlock POLYSEXUAL_STAINED_GLASS = (StainedGlassBlock) registerBlock("polysexual_stained_glass",new StainedGlassBlock(DyeColor.WHITE, glass("polysexual_stained_glass")));
...
// Sign blocks — set by platform-specific modules (Terraform on Fabric, vanilla on Forge)
    ...
    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(LandCommon.MOD_ID, name),
                new BlockItem(block, new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(LandCommon.MOD_ID, name))).useBlockPrefixedTranslationKey()));
    }
