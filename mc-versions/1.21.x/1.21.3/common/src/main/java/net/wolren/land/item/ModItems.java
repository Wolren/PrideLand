...
public class ModItems {
    ...
    public static final ArmorItem RAINBOW_HELMET = (ArmorItem) registerItem("rainbow_helmet",
            new ArmorItem(RainbowArmorMaterial.RAINBOW, EquipmentType.HELMET, new Item.Settings().maxCount(1).fireproof()));
    public static final ArmorItem RAINBOW_CHESTPLATE = (ArmorItem) registerItem("rainbow_chestplate",
            new ArmorItem(RainbowArmorMaterial.RAINBOW, EquipmentType.CHESTPLATE, new Item.Settings().maxCount(1).fireproof()));
    public static final ArmorItem RAINBOW_LEGGINGS = (ArmorItem) registerItem("rainbow_leggings",
            new ArmorItem(RainbowArmorMaterial.RAINBOW, EquipmentType.LEGGINGS, new Item.Settings().maxCount(1).fireproof()));
    public static final ArmorItem RAINBOW_BOOTS = (ArmorItem) registerItem("rainbow_boots",
            new ArmorItem(RainbowArmorMaterial.RAINBOW, EquipmentType.BOOTS, new Item.Settings().maxCount(1).fireproof()));
    ...
    public static final AxeItem RAINBOW_AXE = (AxeItem) registerItem("rainbow_axe",
            new AxeItem(ToolMaterial.NETHERITE, 5.0F, -3.0F, new Item.Settings().maxCount(1).fireproof()));
    public static final HoeItem RAINBOW_HOE = (HoeItem) registerItem("rainbow_hoe",
            new HoeItem(ToolMaterial.NETHERITE, -1.0F, -1.0F, new Item.Settings().maxCount(1).fireproof()));
    public static final PickaxeItem RAINBOW_PICKAXE = (PickaxeItem) registerItem("rainbow_pickaxe",
            new PickaxeItem(ToolMaterial.NETHERITE, 1.0F, -2.8F, new Item.Settings().maxCount(1).fireproof()));
    public static final ShovelItem RAINBOW_SHOVEL = (ShovelItem) registerItem("rainbow_shovel",
            new ShovelItem(ToolMaterial.NETHERITE, 1.5F, -3.0F, new Item.Settings().maxCount(1).fireproof()));
    public static final SwordItem RAINBOW_SWORD = (SwordItem) registerItem("rainbow_sword",
            new SwordItem(ToolMaterial.NETHERITE, 3.0F, -2.4F, new Item.Settings().maxCount(1).fireproof()));
