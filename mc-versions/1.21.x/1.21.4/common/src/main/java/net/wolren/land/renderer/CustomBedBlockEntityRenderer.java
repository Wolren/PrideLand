...
public class CustomBedBlockEntityRenderer implements BlockEntityRenderer<CustomBedBlockEntity> {
    ...
    @Override
    public void render(CustomBedBlockEntity customBedBlockEntity, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
