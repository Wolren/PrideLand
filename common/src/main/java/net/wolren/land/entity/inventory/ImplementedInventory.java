package net.wolren.land.entity.inventory;
...
public interface ImplementedInventory extends WorldlyContainer {
     ...
     *
     * <p>The default implementation uses {@link Inventories#removeStack(NonNullList, int)}
     *
     * @param slot the slot
    ...
    default ItemStack removeItemNoUpdate(int slot) {
        return ContainerHelper.removeItem(getItems(), slot, Integer.MAX_VALUE);
    }

    /**
     * Replaces the current stack in the {@code slot} with the provided stack.
     *
     * <p>If the stack is too big for this inventory ({@link Inventory#getMaxStackSize()}),
