...
public class ModItems {
    public static final Item RAINBOW_DYE = registerItem("rainbow_dye", new Item(new Item.Properties()));
    ...
    public static final ArmorItem RAINBOW_HELMET = (ArmorItem) registerItem("rainbow_helmet",
            new ArmorItem(RainbowArmorMaterial.RAINBOW, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1).fireResistant()));
    public static final ArmorItem RAINBOW_CHESTPLATE = (ArmorItem) registerItem("rainbow_chestplate",
            new ArmorItem(RainbowArmorMaterial.RAINBOW, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1).fireResistant()));
    public static final ArmorItem RAINBOW_LEGGINGS = (ArmorItem) registerItem("rainbow_leggings",
            new ArmorItem(RainbowArmorMaterial.RAINBOW, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1).fireResistant()));
    public static final ArmorItem RAINBOW_BOOTS = (ArmorItem) registerItem("rainbow_boots",
            new ArmorItem(RainbowArmorMaterial.RAINBOW, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1).fireResistant()));
    ...
    public static final AxeItem RAINBOW_AXE = (AxeItem) registerItem("rainbow_axe",
            new AxeItem(Tiers.NETHERITE, 5.0f, -3.0f, new Item.Properties().stacksTo(1).fireResistant()));
    public static final HoeItem RAINBOW_HOE = (HoeItem) registerItem("rainbow_hoe",
            new HoeItem(Tiers.NETHERITE, -4, 0.0f, new Item.Properties().stacksTo(1).fireResistant()));
    public static final PickaxeItem RAINBOW_PICKAXE = (PickaxeItem) registerItem("rainbow_pickaxe",
            new PickaxeItem(Tiers.NETHERITE, 1, -2.8f, new Item.Properties().stacksTo(1).fireResistant()));
    public static final ShovelItem RAINBOW_SHOVEL = (ShovelItem) registerItem("rainbow_shovel",
            new ShovelItem(Tiers.NETHERITE, 1.5f, -3.0f, new Item.Properties().stacksTo(1).fireResistant()));
    public static final SwordItem RAINBOW_SWORD = (SwordItem) registerItem("rainbow_sword",
            new SwordItem(Tiers.NETHERITE, 3, -2.4f, new Item.Properties().stacksTo(1).fireResistant()));



    public static final RainbowSpawnEggItem RAINBOW_SHEEP_SPAWN_EGG = (RainbowSpawnEggItem) registerItem("rainbow_sheep_spawn_egg", new RainbowSpawnEggItem(ModEntities.RAINBOW_SHEEP, 0xFFFFFF, 0xFF69B4, new Item.Properties()));



    private static Item registerItem(String name, Item item) {
        return Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(LandCommon.MOD_ID, name), item);
    }
