...
public class ModItemGroups {
    public static ItemGroup PRIDE_LAND_GROUP;

    public static void registerItemGroups() {
        PRIDE_LAND_GROUP = FabricItemGroup.builder(new Identifier(Land.MOD_ID, "pride_land")).displayName(Text.translatable("itemgroup.pride_land_group")).icon(() ->
